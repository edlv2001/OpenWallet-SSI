...
public class VerifiablePresentationCreator {
    ...
    public VerifiablePresentation issueVP(@NotNull String schema, String vc, String did, Date expirationDate, boolean store){
    ...
    private void store(VerifiablePresentation vp){
        ...
        File file = new File(created, "VerifiablePresentation_" + VerifiableCredentialIssuer.hash(vp));
        if(file.exists()){
